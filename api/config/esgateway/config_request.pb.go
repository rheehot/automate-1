...
type ConfigRequest_V1_System_External struct {
	...
	// TODO(ssd) 2020-12-01: Mark as deprecrated?
...
type ConfigRequest_V1_System_Nginx_Main struct {
	...
	Resolvers       []*wrappers.StringValue `protobuf:"bytes,3,rep,name=resolvers,proto3" json:"resolvers,omitempty" toml:"resolvers,omitempty" mapstructure:"resolvers,omitempty"`
}
