...
func (x *EnvironmentRecipesList) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
func (x *EnvironmentRecipesList) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
var file_external_infra_proxy_request_environments_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x60, 0x0a, 0x16, 0x45, 0x6e, 0x76, 0x69, 0x72,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74,
...
var file_external_infra_proxy_request_environments_proto_goTypes = []interface{}{
	...
	(*EnvironmentRecipesList)(nil), // 4: chef.automate.api.infra_proxy.request.EnvironmentRecipesList
