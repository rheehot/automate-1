...
type UpdateNodeAttributes struct {
	...
	// Node name.
	Name string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty" toml:"name,omitempty" mapstructure:"name,omitempty"`
	// Node attribute type. (e.g. 'normal', 'default').
	Type string `protobuf:"bytes,4,opt,name=type,proto3" json:"type,omitempty" toml:"type,omitempty" mapstructure:"type,omitempty"`
	// Node attributes JSON.
	Attributes *_struct.Struct `protobuf:"bytes,5,opt,name=attributes,proto3" json:"attributes,omitempty" toml:"attributes,omitempty" mapstructure:"attributes,omitempty"`
}
...
func (x *UpdateNodeAttributes) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
var file_interservice_infra_proxy_request_nodes_proto_rawDesc = []byte{
	...
	0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0xab, 0x01, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x61,
	...
	0x75, 0x74, 0x65, 0x73, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_interservice_infra_proxy_request_nodes_proto_depIdxs = []int32{
	...
	6, // 4: chef.automate.domain.infra_proxy.request.UpdateNodeAttributes.attributes:type_name -> google.protobuf.Struct
